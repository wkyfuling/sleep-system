...
EXISTING_DEEPSEEK_ASSISTANT_MODEL="$(read_existing_env DEEPSEEK_ASSISTANT_MODEL)"
...
DEEPSEEK_ASSISTANT_MODEL="${DEEPSEEK_ASSISTANT_MODEL:-${EXISTING_DEEPSEEK_ASSISTANT_MODEL:-$DEEPSEEK_MODEL}}"
...
DEEPSEEK_ASSISTANT_MODEL=$DEEPSEEK_ASSISTANT_MODEL
