...
DEEPSEEK_ASSISTANT_MODEL = os.getenv("DEEPSEEK_ASSISTANT_MODEL", DEEPSEEK_MODEL)
DEEPSEEK_ASSISTANT_TIMEOUT_SECONDS = float(os.getenv("DEEPSEEK_ASSISTANT_TIMEOUT_SECONDS", "45"))
DEEPSEEK_ASSISTANT_MAX_TOKENS = int(os.getenv("DEEPSEEK_ASSISTANT_MAX_TOKENS", "320"))
DEEPSEEK_ASSISTANT_TEMPERATURE = float(os.getenv("DEEPSEEK_ASSISTANT_TEMPERATURE", "0.4"))
